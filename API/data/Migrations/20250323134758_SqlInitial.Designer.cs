...
namespace API.Data.Migrations
{
    ...
    [Migration("20250323134758_SqlInitial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.AppUserRole", b =>
                {
                    ...
                    b.HasOne("API.Models.AppUsers", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("API.Models.Message", b =>
                {
                    b.HasOne("API.Models.AppUsers", "Recipient")
            ...
            modelBuilder.Entity("API.Models.UserLike", b =>
                {
                    b.HasOne("API.Models.AppUsers", "SourceUser")
                        .WithMany("LikedUsers")
                        .HasForeignKey("SourceUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Models.AppUsers", "TargetUser")
